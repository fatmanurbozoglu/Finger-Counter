Bu projenin amacı, Python ve OpenCV kullanarak kamera görüntülerinden el hareketlerini algılayıp parmak sayısını doğru bir şekilde tespit edebilen bir yapay zekâ sistemi geliştirmektir. 
